...
namespace HealthAndBeauty
{
    public static class NutritionixApiService
    {
        ...
        {
            //_baseUrl = "https://trackapi.nutritionix.com/v2/natural/nutrients";
            _baseUrl = "https://trackapi.nutritionix.com/v2/search/instant";
        ...
        public static async Task<string> GetProductCalorific(string product)
        {
            Foods foodsArray = null;
            try
            {
                foodsArray = await _baseUrl
            ...
            return foodsArray.Info[0].Calorific.ToString();
        }
